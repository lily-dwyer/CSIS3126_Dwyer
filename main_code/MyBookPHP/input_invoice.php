...
$sql = "SELECT MAX(invoice_num) AS last_invoice FROM invoices WHERE customer_id=$my_customer_id AND company_id=$user_id;";
$query = mysqli_query($connection, $sql);
$row = mysqli_fetch_assoc($query);
$invoice_num = ($row["last_invoice"] !== null) ? $row["last_invoice"] + 1 : 1;
